...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`userId`),
  UNIQUE KEY `emailHash_UNIQUE` (`emailHash`),
...
INSERT INTO `users` VALUES (1230,'U2FsdGVkX1/anthBXfR5E87VcUHBwbBZFaeA5mD0/i0B95Qp0jsAXEwecq6BUt+g','bb064db2fa23a0b9c7003cfa962ef773','Christophe','Delarue','$2b$10$CqDgoJDBHzdOfmZ2pRTNluibodUQA7b7PoqlaVw0KefqF5ROBDHYS','$2b$10$CqDgoJDBHzdOfmZ2pRTNluibodUQA7b7PoqlaVw0KefqF5ROBDHYS',0);
...
CREATE TABLE `comment` (
  ...
  CONSTRAINT `users_userId` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE
